...
export class DevPanel {
    ...
    _initDOM() {
      ...
      this.$("#btn-anim-toggle").addEventListener("click", () => {
        if (!this.anim) return;
        if (this._animPlaying) { this.anim.pauseAll?.(); this._animPlaying = false; }
        else { this.anim.resumeAll?.(); this._animPlaying = true; }
      });
    ...
    show()  { this._visible = true;  this.root.style.display = "block"; }
